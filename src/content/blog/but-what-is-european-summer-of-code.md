...
description: "European Summer of Code program and my personal experience getting started with open source contributions."
pubDate: 2025-05-25
...
I was selected for ESoC in its inaugral session and since sharing the news, I've received a ton of messages from folks asking, "What is ESoC?", "How did you apply?", or "How can I get in too?"
...
I first came across sktime while working on a hackathon project where we had to build a pipeline to predict the prices of agricultural commodities in the Indian market which is a time series problem. I liked how helpful the sktime community was and they also had a mentorship program. The mentorship program was unpaid but it was a great opportunity to learn with experienced mentors. So, after making my first significant pull request, I joined it and ended up learning a lot.
...
By that time, I already had enough experience contributing to sktime and had grown to love the community, so I dropped my plans to apply to GSoC with other organizations and withdrew my application. Looking back, I think it was a great decision. After a month or so it made me so happy when I finally got the acceptence email for the ESoC program!

To anyone getting started - just start it and have fun contributing, the rewards will follow :)
